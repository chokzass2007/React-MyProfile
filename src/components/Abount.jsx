...
const Abount = () => {
    return (
        <div className='about-head'>
            <div className="sectionSubtext">Introdution</div>
            <h2 className="sectionHeadText">Overview</h2>

            <div className="about-text">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque pariatur placeat,
                 ab quidem deserunt perspiciatis ducimus tempora consequuntur magni dolor commodi tempore, 
                 voluptate laborum cupiditate enim, sunt dolorem. Quos, earum.
